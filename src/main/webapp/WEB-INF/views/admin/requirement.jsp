...
$(document).ready(function() {
	...
	$("#join").click(function() {
		...
		$.ajax({
			type : "POST",
			url : '/admin/requirement_r.do',
			dataType : 'JSON',
			cache : false,
			data : formData,
			success : function(data) {
				Responser.action(data);
				alert("배정요청을 성공적으로 수행하였습니다.");
				self.close();
			},
...
<div id="splash" class="subline" style="padding-top: 0px; margin-top: 0xp;">
	<div class="sub-nav-img">
		<div class="people5">${offerer.offererName} 배정요청</div>
	</div>
	<form method="post" id="form">
		...
		<table class="data-table">
			...
			<tr>
				<th></th>
				<td>
					<input type="button" id="join" class="smallbutton" value="배정요청" style="width: 40%;">
				</td>
			</tr>
		</table>
	</form>
