...
INSERT INTO `assignment` VALUES (4,'010-000-0003',0,'2016-03-04 02:22:04'),(4,'010-1254-3112',0,'2016-03-04 02:22:04'),(5,'010-000-0001',0,'2016-03-04 02:22:04'),(5,'010-000-0002',0,'2016-03-04 02:22:04'),(5,'010-000-0005',0,'2016-03-04 02:22:04'),(8,'010-212-2312',0,'2016-03-04 02:22:04'),(11,'010-000-0004',0,'2016-03-04 02:22:04');
...
--
-- Table structure for table `kaka_user`
--

DROP TABLE IF EXISTS `kaka_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `kaka_user` (
...
--
-- Dumping data for table `kaka_user`
--

LOCK TABLES `kaka_user` WRITE;
/*!40000 ALTER TABLE `kaka_user` DISABLE KEYS */;
INSERT INTO `kaka_user` VALUES ('kinow','qwe123');
/*!40000 ALTER TABLE `kaka_user` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `offerer_cancel_history`
--

DROP TABLE IF EXISTS `offerer_cancel_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `offerer_cancel_history` (
  `requirementId` int(11) unsigned NOT NULL,
  `offererId` varchar(32) NOT NULL,
  `datetime` datetime NOT NULL,
  PRIMARY KEY (`requirementId`,`offererId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `offerer_cancel_history`
--

LOCK TABLES `offerer_cancel_history` WRITE;
/*!40000 ALTER TABLE `offerer_cancel_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `offerer_cancel_history` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `seeker_cancel_history`
--

DROP TABLE IF EXISTS `seeker_cancel_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seeker_cancel_history` (
  `requirementId` int(11) unsigned NOT NULL,
  `offererId` varchar(32) NOT NULL,
  `seekerId` varchar(13) NOT NULL,
  `datetime` datetime NOT NULL,
  PRIMARY KEY (`requirementId`,`offererId`,`seekerId`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `seeker_cancel_history`
--

LOCK TABLES `seeker_cancel_history` WRITE;
/*!40000 ALTER TABLE `seeker_cancel_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `seeker_cancel_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `seeker_confirm_after_cancel_history`
--

DROP TABLE IF EXISTS `seeker_confirm_after_cancel_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seeker_confirm_after_cancel_history` (
  `requirementId` int(11) unsigned NOT NULL,
  `offererId` varchar(32) NOT NULL,
  `seekerId` varchar(13) NOT NULL,
  `datetime` datetime NOT NULL,
...
--
-- Dumping data for table `seeker_confirm_after_cancel_history`
--

LOCK TABLES `seeker_confirm_after_cancel_history` WRITE;
/*!40000 ALTER TABLE `seeker_confirm_after_cancel_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `seeker_confirm_after_cancel_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `seeker_confirm_history`
--

DROP TABLE IF EXISTS `seeker_confirm_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seeker_confirm_history` (
  `requirementId` int(11) unsigned NOT NULL,
  `offererId` varchar(32) NOT NULL,
  `seekerId` varchar(13) NOT NULL,
  `datetime` datetime NOT NULL,
...
--
-- Dumping data for table `seeker_confirm_history`
--

LOCK TABLES `seeker_confirm_history` WRITE;
/*!40000 ALTER TABLE `seeker_confirm_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `seeker_confirm_history` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `seeker_notice_history`
--

DROP TABLE IF EXISTS `seeker_notice_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seeker_notice_history` (
  `requirementId` int(11) unsigned NOT NULL,
  `offererId` varchar(32) NOT NULL,
  `seekerId` varchar(13) NOT NULL,
  `datetime` datetime NOT NULL,
...
--
-- Dumping data for table `seeker_notice_history`
--

LOCK TABLES `seeker_notice_history` WRITE;
/*!40000 ALTER TABLE `seeker_notice_history` DISABLE KEYS */;
INSERT INTO `seeker_notice_history` VALUES (4,'test1','010-000-0003','2016-03-04 02:22:04'),(4,'test1','010-1254-3112','2016-03-04 02:22:04'),(5,'test10','010-000-0001','2016-03-04 02:22:04'),(5,'test10','010-000-0002','2016-03-04 02:22:04'),(5,'test10','010-000-0005','2016-03-04 02:22:04'),(8,'mama1','010-212-2312','2016-03-04 02:22:04'),(11,'mama1','010-000-0004','2016-03-04 02:22:04');
/*!40000 ALTER TABLE `seeker_notice_history` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-03-06 11:13:17
